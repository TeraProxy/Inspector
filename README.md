Waiting for a commit of my S_USER_PAPERDOLL_INFO.4.  
If you want to use the module now, you need to copy the file to [tera-proxy]/node_modules/tera-data/protocol.  
